...
if __name__ == "__main__":
    ...
    argparser.add_argument('subject', type=str, help='Subject nr', default='test')
    argparser.add_argument('session', type=str, help='Session', default=1)
    argparser.add_argument('start_run', type=int, help='Run', default=1)
    argparser.add_argument('range', choices=['narrow', 'wide'], help='Range (either narrow or wide)', default='narrow')
